...
"@fontsource-variable/fira-code": "^5.2.8",
"@fontsource-variable/fira-sans": "^5.2.8",
...
@import "@fontsource-variable/fira-sans";
```
...
@theme inline {
  /* 字体（§3.5.3） */
  --font-sans: "Fira Sans Variable", "Fira Sans", "PingFang SC", "Microsoft YaHei UI", sans-serif;
  --font-heading: "Fira Sans Variable", "Fira Sans", "PingFang SC", "Microsoft YaHei UI", sans-serif;
...
| 13 | DevTools Computed → Font Family | body 为 `Fira Sans Variable`，`asset_code` 列为 `Fira Code Variable`；**无 Inter/Roboto/system-ui/Geist** |
