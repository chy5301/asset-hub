...
2. `docs/superpowers/specs/2026-04-15-asset-hub-design.md` §3.5 修订 "Heading 字体" 条目：从 "Heading: Fira Code" 改为 "正文与标题: Fira Sans；Fira Code 仅用于 mono 字段（asset_code / SN / code_prefix / 时间戳 / 显式 `.font-code` 标记位置）"
