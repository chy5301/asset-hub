    ...
    def record_transition(
        ...
        *,
        ...
        to_status = validate_transition(
            asset.status, kind, _check_holder, _check_location
        )
        ...
        if kind == TransitionKind.REASSIGN:
            holder_changed = (
                not isinstance(to_holder, UnsetType) and to_holder != asset.holder
            )
            location_changed = (
                not isinstance(to_location, UnsetType) and to_location != asset.location
            )
        ...
        to_location_final = _apply_location_rule(
            rule.location_rule, asset.location, to_location
        )
        ...
        closes_id = None
        if (
            asset.status in PERSISTED_CHECKOUT_STATES
        ...
        record = StateTransitionRecord(
            ...
            due_at=due_at
            if kind
            in (TransitionKind.CHECKOUT_INTERNAL, TransitionKind.CHECKOUT_EXTERNAL)
            else None,
